...
if package_version == '0.3.1':
...
elif package_version == 'dev' or vs.parse(package_version) >= vs.parse('0.6.6.post2.dev252+g8027a724'):
    # From 0.6.6.post2 on, vllm supports SPMD inference
    # See https://github.com/vllm-project/vllm/pull/12071
    # Also support 'dev' version as the latest version
    ...
    raise ValueError(
        f'vllm version {package_version} not supported. Currently supported versions are 0.3.1, 0.4.2, 0.5.4, 0.6.3, dev and 0.7.0+'
    )
